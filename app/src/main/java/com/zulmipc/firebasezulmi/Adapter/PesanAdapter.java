...
public class PesanAdapter extends RecyclerView.Adapter<PesanAdapter.ViewHolder> {
    ...
    public PesanAdapter(Context mContext, List<Pesan> mPesan, String imgURL) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        Pesan pesan = mPesan.get(position);
    ...
    public int getItemViewType(int position) {
        ...
        if (mPesan.get(position).getSender().equals(firebaseUser.getUid())) {
